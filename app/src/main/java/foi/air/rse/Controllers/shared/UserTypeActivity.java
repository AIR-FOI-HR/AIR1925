package foi.air.rse.Controllers.shared;
...
public class UserTypeActivity extends AppCompatActivity {
    ...
    public void openActivitySignUpRestaurant(){
        Intent homeIntetnt = new Intent(UserTypeActivity.this, foi.air.rse.Controllers.restaurant.auth.SignUpActivity.class);
        startActivity(homeIntetnt);
    }
}
